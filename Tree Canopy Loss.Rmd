...
```{r Tree Canopy 08, 18, message=FALSE, warning=FALSE, cache=TRUE, include=TRUE, results='hide', fig.height = 13, fig.width = 9}
...
ggplot()+ 
  geom_sf(data = Canopy18, aes(fill = CLASS_NAME), color = NA)+ 
...
ggplot()+ 
  geom_sf(data = Philadelphia, fill = "gray10")+
  geom_sf(data = fishnet, color = "black")+ 
  labs(title = "Philadelphia Fishnet : 200m x 200m")+ 
  mapTheme()
...
TreeCanopyCoverage18 <- 
  ...
  mutate(pctCoverage18 = AreaCoverage / 4635409)%>%
  st_drop_geometry()
...
ggplot(TreeCanopyCoverage18, aes(x = pctGain, y = pctCoverage))+
  geom_point()+ 
...
ggplot(TreeCanopyCoverage18, aes(x = pctLoss, y = pctCoverage))+
  geom_point()+ 
...
ggplot(FinalFishnet, aes(x = GainMinusLoss, y = pctCoverage))+
  ...
  labs(title = "Percent Tree Canopy Gain (2008 - 2018) Minust Percent Tree Canopy Loss \n vs. Percent Tree Canopy Coverage (2018)", 
       subtilte = "Aggregated by Fishnet") + 
  xlab("Percent of Tree Canopy GainedFrom 2008 - 2018 \n Minus Percent of Tree Canopy Lossed From 2008 - 2018 ") + 
  ylab("Percent of Tree Canopy Coverage of Fishnet Cell (2018)") + 
...
```{r Additional Fishnet/Neighborhood Visualizations, message=FALSE, warning=FALSE, fig.height = 18, fig.width = 13}
