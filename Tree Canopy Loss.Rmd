...
```{r Additional Fishnet/Neighborhood Visualizations, message=FALSE, warning=FALSE, fig.height = 10, fig.width = 6}
...
ggplot(correlation.long, aes(Value, GainMinusLoss)) +
  ...
  labs(title = "Gain - Loss as a function of Demographic Risk Factors") +
  plotTheme()
...
ggplot(correlation.long1, aes(Value, pctLoss)) +
  ...
  geom_smooth(method = "lm", se = FALSE, colour = "red") +
  facet_wrap(~Variable, ncol = 2, scales = "free") +
  labs(title = "Percent Loss as a function of Demographic Risk Factors") +
  plotTheme()
...
ggplot(correlation.long2, aes(Value, pctGain)) +
  ...
  geom_smooth(method = "lm", se = FALSE, colour = "red") +
  facet_wrap(~Variable, ncol = 2, scales = "free") +
  labs(title = "Percent Gain as a function of Demographic Risk Factors") +
  plotTheme()
```
