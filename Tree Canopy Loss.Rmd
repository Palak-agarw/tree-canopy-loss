...
## Use Case
The aim of this project is identify risk for tree canopy loss in Philadelphia, PA. The urban tree canopy is important for many reasons including public health and recreation, and Philadelphia has a goal of achieving 30% tree canopy coverage in each neighborhood.
...
## Methods
Our model primarily uses data from the City of Philadelphia's tree canopy layer dataset, which consists of tree canopy polygons layered as loss or gain from 2008-2018. In addition, we use tract-level neighborhood sociodemographic attribute data from the American Community Survey (ACS), environmental and city service data from OpenDataPhilly, and Home Owner's Loan Corporation redlining data from 1937.

Data from the American Community Survey and the Home Owner's Loan Corporation represent the current and past social conditions which affect tree canopy coverage in a given neighborhood. Data from OpenDataPhilly gives us an idea of recent city services and environmental conditions which may impact tree canopy coverage. Following is a list of the independent variables we use:  
...
We divide the city into ____ fishnet grid cells of ________ each and use these cells as our unit of analysis.
...
```{r Fishnet Aggregation, message=FALSE, warning=FALSE, results='hide'}
...
ggplot()+ 
  ...
  scale_fill_manual(values = palette2,
                    ...
                    name = "Area Gain (ft^2)")+
  labs(title= "Tree Canopy Gain in Each Fishnet Cell, 2008 - 2018", 
...
ggplot()+ 
  ...
  labs(title= "Tree Canopy Loss in Each Fishnet Cell, 2008 - 2018")+
  theme(plot.title = element_text(hjust = 0.3)) + mapTheme(),
...
ggplot()+ 
  ...
  labs(title= "Total Tree Canopy by Fishnet", 
       subtitle = "Combining 2008 Tree Canopy Coverage with 2018 Tree Canopy Coverage")+
  theme(plot.title = element_text(hjust = 0.3)) + mapTheme()) 
...
ggplot()+ 
  ...
  scale_fill_manual(values = palette2,
                    ...
                    name = "Percent Gain")+
  labs(title= "Percent Tree Canopy Gain, 2008 - 2018", 
...
ggplot()+ 
  ...
  scale_fill_manual(values = palette2,
                    ...
                    name = "Percent Loss")+
  labs(title= "Percent Tree Canopy Loss, 2008 - 2018", 
       subtitle = "2008 - 2018 Tree Canopy Loss / Total Tree Canopy Coverage (2008, 2018)")+
  theme(plot.title = element_text(hjust = 0.3)) + mapTheme(),
...
ggplot()+ 
  ...
  labs(title= "Net Percent Gain / Loss (2018 - 2019)", 
       subtitle = "Percent Tree Canopy Gain (2008 - 2018) Minus Percent Tree Canopy Loss (2008 - 2018)") +
  theme(plot.title = element_text(hjust = 0.3)) + mapTheme()) 
...
ggplot(FinalFishnet, aes(x = pctGain, y = pctCoverage18))+
  ...
  xlab("Percent of Tree Canopy Gained (2008 - 2010") + 
  ylab("Percent of Tree Canopy Coverage of Fishnet Cell (2018)") + 
...
ggplot(FinalFishnet, aes(x = GainMinusLoss, y = pctCoverage18))+
  geom_point()+ 
