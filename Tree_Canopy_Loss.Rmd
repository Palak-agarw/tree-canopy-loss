...
a <- ggplot()+ 
               geom_sf(data = FinalFishnet, aes(fill = PctChange))+ 
              # scale_fill_manual(values = palette5, name = "Area Loss (f^2)")+
               labs(title= "How Much Tree Canopy Was Lost in Each Gridcell \n From 2008 - 2018?")+
               mapTheme()
...
a + scale_fill_distiller(palette= "YlOrRd", direction = 1)
b + scale_fill_distiller(palette = "RdYlGn", direction = 1)
