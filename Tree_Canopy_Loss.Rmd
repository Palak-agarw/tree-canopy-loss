...
```{r Study boundaries, cache=TRUE, message=FALSE, warning=FALSE, include=FALSE, results='hide'}
ggmap(base_map) +
...
```{r Fishnet, cache=TRUE, message=FALSE, warning=FALSE, include=FALSE, results='hide'}
...
```{r Existing Canopy, cache=TRUE, message=FALSE, warning=FALSE, include=FALSE, results='hide'}
...
```{r Existing Canopy fishnet, cache=TRUE, message=FALSE, warning=FALSE, include=FALSE, results='hide'}
ggmap(base_map) +
...
```{r Redlining Neighborhoods, message=FALSE, warning=FALSE, include=FALSE, results='hide', cache='TRUE'}
...
```{r Residential and transportation, message=FALSE, warning=FALSE, include=FALSE, results='hide', fig.height = 4, fig.width = 10, cache=TRUE}
...
```{r residential density, message=FALSE, warning=FALSE, include=FALSE, results='hide', cache=TRUE}
resDensity
```
...
```{r factor maps, fig.height = 12,fig.width = 12, message=FALSE, warning=FALSE, include=FALSE, results='hide', cache=TRUE}
...
```{r CV, message=FALSE, warning=FALSE, fig.height = 4, fig.width = 6, include=FALSE, results='hide', cache=TRUE}  
## Cross validation
