...
```{r Canopy change, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
...
```{r Neighborhood canopy change, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
...
```{r UR and RM reference map, message=FALSE, warning=FALSE, results='hide', cache = TRUE}
...
```{r UR and RM maps, message=FALSE, warning=FALSE, results='hide', cache = TRUE}
...
```{r HOLC Grades for Neighborhoods, message=FALSE, warning=FALSE, include=TRUE, results='hide', cache='TRUE'}
...
```{r residential density, message=FALSE, warning=FALSE, include=TRUE, results='hide', cache=TRUE}
resDensity
```
...
```{r confusion metrics, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
# ROC Curve
...
```{r ROC curve, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
rocCurve
```


# Results and Construction Scenarios
```{r Construction_scenarios, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r prediction 1, message=FALSE, warning=FALSE, cache=TRUE}
original
```
...
```{r Confusion metrics, message=FALSE, warning=FALSE, cache=TRUE}  
...
```{r confusion plot, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r Spatial Cross Validation, message=FALSE, warning=FALSE, cache=TRUE, results=FALSE}
# Model Validation
