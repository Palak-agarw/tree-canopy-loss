...
FinalFishnet1 <- 
  ...
  mutate(PctGainMinusLoss = (AreaCoverage08-AreaCoverage18) / (AreaCoverage08) * 100 * (-1))%>%
...
ggplot()+ 
  ...
  labs(title= " What is the Net Percent Change in Tree Cnaopy from 2008- 2018?", 
       subtitle = "(2008 Tree Coverage - 2018 Tree Coverage / 2008 Tree Coverage) * 100") +
...
ggplot(pctNetGraph, aes(x = PctGainMinusLoss, y = AreaCoverage18))+
  ...
  labs(title = "Percent Tree Canopy Gain Minus Percent Tree Canopy Loss \n vs. Percent Tree Canopy Coverage (2018)", 
       subtilte = "Aggregated by Fishnet") + 
  xlab("Net Tree Canopy Percent Change ") + 
