...
```{r Neighborhood Maps, message=FALSE, warning=FALSE, results='hide', fig.height = 10, fig.width = 20, cache=TRUE}
...
```{r Residential density, message=FALSE, warning=FALSE, include=TRUE, results='hide', fig.height = 6, fig.width = 10, cache=TRUE}
