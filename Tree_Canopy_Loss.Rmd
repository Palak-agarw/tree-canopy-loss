...
```{r Set Up, message=FALSE, warning=FALSE, include=TRUE, results='hide', cache=TRUE}
#Reload
...
```{r Study boundaries, cache=TRUE, message=FALSE, warning=FALSE, include=TRUE, results='hide'}
ggmap(base_map) +
...
```{r Existing Canopy, cache=TRUE, message=FALSE, warning=FALSE, include=TRUE, results='hide'}
ggmap(base_map) +
...
```{r Canopy change, message=FALSE, warning=FALSE, results='hide', fig.height = 12, fig.width = 20, cache=TRUE}
...
```{r Comparing Canopy Area to Loss/Gain2, message=FALSE, warning=FALSE, results='hide', fig.height = 6, fig.width = 9,  cache=TRUE}
...
```{r Net Canopy change,  message=FALSE, warning=FALSE, results='hide', fig.height = 8, fig.width = 8, cache=TRUE}
...
```{r Neighborhood Canopy goal, message=FALSE, warning=FALSE, results='hide', fig.height = 10, fig.width = 20, cache=TRUE}
...
```{r Neighborhood canopy change, message=FALSE, warning=FALSE, results='hide', fig.height = 10, fig.width = 20, cache=TRUE}
...
```{r Neighborhood Level Loss, message=FALSE, warning=FALSE, results='hide', fig.height = 13, fig.width = 13, cache = TRUE}
...
```{r Demographics, message=FALSE, warning=FALSE, results='hide', fig.height = 10, fig.width = 13,  cache=TRUE}
...
```{r HOLC Areas, message=FALSE, warning=FALSE, include=TRUE, results='hide', fig.height =  7, fig.width = 7, cache='TRUE'}
...
FinalFishnet <-
 ...
 holcLoss <- FinalFishnet %>%
  ...
  ggplot() +
  geoom_bar(aes(y = mean_loss), binwidth = 1, fill = "magenta") +
...
```{r HOLC plot, fig.height=8, fig.width=12, message=FALSE, warning=FALSE, cache=TRUE, results='hide'}
library(grid)
...
```{r land use, message=FALSE, warning=FALSE, include=TRUE, results='hide', fig.height = 5, fig.width = 8, cache=TRUE}
...
```{r Residential density, message=FALSE, warning=FALSE, include=TRUE, results='hide', fig.height = 4, fig.width = 10, cache=TRUE}
...
```
```{r p health, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
...
```{r tree removal and const, fig.height = 12,fig.width = 12, message=FALSE, warning=FALSE, include=TRUE, results='hide', cache=TRUE}
...
```{r factor maps, fig.height = 12,fig.width = 12, message=FALSE, warning=FALSE, include=TRUE, results='hide', cache=TRUE}
...
```{construction in 3 neighborhoods, fig.height = 12,fig.width = 12, message=FALSE, warning=FALSE, include=TRUE, results='hide', cache=TRUE}
grid.arrange(pbNeigh, urNeigh, rmNeigh, ncol = 1, top = "Construction and Canopy Loss in 3 Neighborhoods")
```

```{morans i, message=FALSE, warning=FALSE, include=TRUE, results='hide'}
library(spdep)
library(FNN)
library(spatstat)
...
```{r Construction_scenarios, message=FALSE, warning=FALSE, fig.height = 15, fig.width = 10, cache=TRUE}
...
```{r Confusion metrics, message=FALSE, warning=FALSE, fig.height = 6, fig.width = 6, cache=TRUE}  
...
We performed other validation tests to judge the generalizability of our model. First, cross validation with 100 k folds was performed. The graphs below visualize the accuracy and kappa of the final model across folds. Each of these plots are clustered around the mean, indicating our model has decent generalizability. 

``````{r CV, message=FALSE, warning=FALSE, fig.height = 6, fig.width = 6, include=TRUE, results='hide', cache=TRUE}  
## Cross validation
...
```{r spatial_cv, message=FALSE, warning=FALSE, cache=TRUE, results=FALSE}
# Model Validation
