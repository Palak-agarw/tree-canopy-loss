...
Conservation <- #st_read("/Users/annaduan/Desktop/Y3S2/Practicum/Data/Conservation/ConservationEasements202103.shp") %>%
...
st_write(Philadelphia, "C:/Users/Kyle McCarthy/Documents/Practicum/Data/Conservation/philly.shp")
...
```{r Fishnet 2, cache=TRUE, message=FALSE, warning=FALSE, include=TRUE, results='hide'}
...
ggplot(FinalFishnet, aes(y = LogPctLoss, x = LogAvgParcelSize))+
  geom_point(colour = "dark green", size = .5)+
  labs(title = "Percent Tree Canopy Loss (2008 - 2018) vs. \n Percent Tree Canopy Coverage (2018) ",
