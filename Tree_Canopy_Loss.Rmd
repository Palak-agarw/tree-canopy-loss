...
```{r Redlining Neighbs, message=FALSE, warning=FALSE, include=TRUE, results='hide', cache='TRUE'}
...
```{r Metrics Curve, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
# ROC Curve
...
```{r accuracy and other metrics, message=FALSE, warning=FALSE, cache=TRUE}  
