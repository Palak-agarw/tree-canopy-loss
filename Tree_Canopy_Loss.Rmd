...
FinalFishnet <- 
  ...
  mutate(PctGainMinusLoss = (AreaCoverage08-AreaCoverage18) / (AreaCoverage08) * 100)%>%
...
FinalFishnet$PctGainMinusLossCat <- cut(FinalFishnet$PctGainMinusLoss, 
                       ...
                       labels = c("Significant Net Gain", "Moderate Net Gain", "Low Net Gain", "Low Net Loss", "Moderate Net Loss", "Significant Net Loss"), 
                       right = FALSE)
...
ggplot(pctNetGraph, aes(x = PctGainMinusLoss, y = AreaCoverage18))+
  geom_point()+ 
