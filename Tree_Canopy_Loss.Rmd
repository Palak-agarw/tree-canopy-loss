...
```{r Comparing Canopy Area to change, message=FALSE, warning=FALSE, results='hide', fig.height = 6, fig.width = 9,  cache=TRUE}
...
```{r Neighborhood Canopy goal, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
...
```{r UR and RM Map, fig.height=7, fig.width=12, message=FALSE, warning=FALSE, cache=FALSE, results='hide'}
...
```{r HOLC Grade Neighborhoods, message=FALSE, warning=FALSE, include=TRUE, results='hide', cache='TRUE'}
...
```{r CV, message=FALSE, warning=FALSE, fig.height = 4, fig.width = 6, include=TRUE, results='hide', cache=TRUE}  
## Cross validation
...
grid.arrange(ncol = 2, top = "LOGO Cross Validation vs Random Forest Risk Predictions", logoPlot, predictionPlot)
