...
```{r Residential density, message=FALSE, warning=FALSE, include=TRUE, results='hide', fig.height = 10, fig.width = 5, cache=TRUE}
...
phillyhealth <- phillyhealth %>%
  ...
  rename(Asthma = casthma_crudeprev,
         ...
         Physical_health = pthlth_crudeprev,
...
less50 <- ggplot() +
  ...
  scale_fill_manual(values=palette5, name="Risk Score") +
  labs(title="Construction reduced by 50%")+
  mapTheme()
...
more50 <- ggplot() +
  ...
  scale_fill_manual(values=palette5, name="Risk Score") +
  labs(title="Construction increased by 50%")+
  mapTheme()
...
grid.arrange(less50, less25, original, more25, more50, ncol = 5, top = "Canopy Loss Risk Under Construction Scenarios", mylegend)
