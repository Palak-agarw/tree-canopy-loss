...
```{r Comparing Canopy Area to Loss/Gain2, message=FALSE, warning=FALSE, results='hide', fig.height = 8, fig.width = 12,  cache=TRUE}
...
```{r Neighborhood Canopy Mapss, message=FALSE, warning=FALSE, results='hide', fig.height = 10, fig.width = 20, cache=TRUE}
...
```{r Neighborhood Level Loss, message=FALSE, warning=FALSE, results='hide', fig.height = 9, fig.width = 13, cache = TRUE}
...
```{r Const Permits neigh, message=FALSE, warning=FALSE, include=TRUE, results='hide', fig.height = 5, fig.width = 10, cache=TRUE}
...
```{r Logit model, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r Confusion Model, message=FALSE, warning=FALSE, fig.height = 6, fig.width = 6, cache=TRUE}  
