...
```{r Tree Canopy 08, 18, message=FALSE, warning=FALSE, cache=TRUE, include=TRUE, results='hide', fig.height = 8, fig.width = 9}
...
FinalNeighborhood$GainMinusLossCat <- cut(FinalNeighborhood$PctUnderGoal, 
                      breaks = c(-Inf, -75000, -50000, -25000, 0, Inf), 
                       labels = c("Greater Than 75000 Squared Feett lost", "50000-75000 Squared Feet Loss", "25000-50000 Squared Feet Loss", "0-25000 Squared Feet Loss", "Tree Canopy Gain!"), 
                       right = FALSE)
...
ggplot() +
  geom_sf(data = FinalNeighborhood, aes(fill = q5(GainMinusLossCat))) +
  scale_fill_manual(values = palette2, name = "Gain or Loss", 
                    labels = qBr(FinalNeighborhood, "GainMinusLoss"))+ 
  labs(title = "What Neighborhoods are Losing More Tree Canopy Area \n than Gaining Tree Canopy Area?") +
  theme(plot.title = element_text(hjust = 0.1, size = 8))+
  mapTheme()
...
FinalFishnet$AreaCoverage08Cat <- cut(FinalFishnet$AreaCoverage08, 
                       breaks = c(-Inf, 500000, 1000000, 1500000, 2000000, 2500000, Inf), 
                       labels = c("0-500000", "500000-1000000", "1000000-1500000", "1500000 - 2000000", "2000000 - 2500000", "Greater than 2500000"), 
                       right = FALSE)

FinalFishnet$AreaCoverage18Cat <- cut(FinalFishnet$AreaCoverage18, 
                       breaks = c(-Inf, 500000, 1000000, 1500000, 2000000, 2500000, Inf), 
                       labels = c("0-500000", "500000-1000000", "1000000-1500000", "1500000 - 2000000", "2000000 - 2500000", "Greater than 2500000"), 
                       right = FALSE)
...
FinalFishnet$AreaLossCat <- cut(FinalFishnet$AreaLoss, 
                       ...
                       labels = c("Less Than 50,000", "50,000 - 100,000", "100,000-200,000", "200,000 - 400,000", "400,000 - 800,000", "Greater than 800,000"), 
                       right = FALSE)
...
ggplot()+ 
  geom_sf(data = FinalFishnet, aes(fill = AreaCoverage08Cat))+ 
  scale_fill_manual(values = palette5, 
                    name = "2008 Area Coverage (ft^2)")+
  labs(title = "Tree Canopy Coverage, 2008", 
...
ggplot()+ 
  geom_sf(data = FinalFishnet, aes(fill = AreaCoverage18Cat))+ 
     scale_fill_manual(values = palette2, 
                    name = "2008 Area Coverage (ft^2)")+ 
  labs(title = "Tree Canopy Coverage, 2018", 
subtitle = "2018 Tree Canopy Area / Gridcell Size") + 
...
ggplot()+ 
  ...
  scale_fill_manual(values = palette2,
                    name = "Area Gain (ft^2)")+
  labs(title= "How Much Tree Canopy was Gained in Each Gridcell from 2008 - 2018?")+
...
ggplot()+ 
  ...
  scale_fill_manual(values = palette2,
                    name = "Tree Canopy Loss (f^2) \n(Quintile Breaks)")+
  labs(title= "How Much Tree Canopy Was Lost in Each Gridcell from 2008 - 2018?")+
  theme(plot.title = element_text( size = 24), 
        legend.title = element_text(size = 12), 
        legend.text = element_text(size = 10)) + mapTheme()) 
...
ggplot()+ 
  ...
  scale_fill_manual(values = palette6,
                    name = "Percent Gain")+
  labs(title= "What was the Percent Tree Canopy Gain in Each Gridcell?", 
       subtitle = "2008 - 2018 Tree Canopy Gain / Total Tree Canopy Coverage (2008, 2018)")+
  theme(plot.title = element_text(hjust = 0.3)) + mapTheme(),

ggplot()+ 
  geom_sf(data = FinalFishnet, aes(fill = pctLossCat))+ 
  scale_fill_manual(values = palette6,
                    name = "Percent Loss")+
  labs(title= "What was the Percent Tree Canopy Loss in Each Gridcell?", 
       subtitle = " Tree Canopy Loss From 2008 - 2018/ Total Tree Canopy Coverage in 2008")+
  theme(plot.title = element_text(hjust = 0.3)) + mapTheme()) 
```
...
ggplot()+ 
  geom_sf(data = FinalFishnet, aes(fill = q5(PctGainMinusLoss)))+ 
  scale_fill_manual(values = palette2,
                    labels = qBr(FinalFishnet, "PctGainMinusLoss"),
                    name = "Percent Gain - Percent Loss")+
  labs(title= " What is the Net Percent Gain or Loss from 2008- 2018?", 
       subtitle = "Tree Canopy Gain From 2008 - 2018/ Total Tree Canopy Coverage in 2018") +
...
```{r Comparing Tree Canopy Area to Loss/Gain2, message=FALSE, warning=FALSE, fig.height = 7, fig.width = 10 }
...
ggplot(FinalFishnet, aes(x = pctLoss, y = AreaCoverage18))+
  geom_point()+ 
...
ggplot(FinalFishnet, aes(x = PctGainMinusLoss, y = AreaCoverage18))+
  ...
  theme(plot.title = element_text(hjust = 0.5, size = 12), plot.subtitle = element_text(hjust = 0.5, size = 8))
...
ggplot() +
  ...
  geom_sf(data = TreeCanopy %>% filter(CLASS_NAME == "Loss"), colour = "red", fill = "transparent") +
