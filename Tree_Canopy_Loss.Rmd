...
```{r Demographics, message=FALSE, warning=FALSE, results='hide', fig.height = 12, fig.width = 13,  cache=TRUE}
...
```{r HOLC ratings neigh, message=FALSE, warning=FALSE, include=TRUE, results='hide', cache='TRUE'}
...
```{r multiple scenarios, fig.height=18, fig.width=16}
