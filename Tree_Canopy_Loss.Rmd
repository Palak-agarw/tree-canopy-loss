...
FinalNeighborhood$GainMinusLossCat <- cut(FinalNeighborhood$GainMinusLoss, 
                      breaks = c(-Inf, -395242, -15647, 0, Inf), 
                       labels = c("Sustantial loss", "Moderate loss", "Low loss", "Gain"),
                       right = FALSE)
...
```{r Neighborhood Maps, message=FALSE, warning=FALSE, results='hide', fig.height = 8, fig.width = 16, cache=TRUE}
...
grid.arrange(ncol=2, UR, RM, refmap)
```
