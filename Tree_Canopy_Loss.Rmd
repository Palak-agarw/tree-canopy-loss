...
```{r HOLC plots, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
...
FinalFishnet5 <-
  ...
  dplyr::select(pctCoverage18, LogAvgParcelSize,Loge311Count, LogPctRes, avg_nnConst,avg_nnPole,
                                    ...
                                    pctTrans, LogPctResTrans, population, italian, medHHInc, Variable, pctCoverage08Cat)
...
reg.training <- lm(pctLoss ~ ., data = st_drop_geometry(L.training) %>% 
                                    dplyr::select(pctCoverage18, LogAvgParcelSize, avg_nnConst,avg_nnPole,
                                    countConst, pctWhite, pctBach, Loge311Count, pctRes,
