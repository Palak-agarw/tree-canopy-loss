...
The most basic rule for greening is Philly is that *every 10 mintue walk should lead to an acre of park*. 
...
The University of Vermont Spatial Analysis Lab defines each tree canopy area as either having a loss, gain, or no change in tree canopy between 2008 and 2018. Areas where trees were removed are marked as having tree canopy loss. Areas where trees were planted
