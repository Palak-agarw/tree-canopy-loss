...
paletteChange <- c("lavender", "orange", "light green")
...
ggplot() +
   geom_sf(data = const_net, aes(fill = as.factor(countConstCat)), color = NA) + scale_fill_brewer(palette = "Greys", direction = 1, aesthetics = c("fill"), colour = "red", guide = guide_legend(reverse = TRUE), name = "Permit Count") +
   #scale_fill_viridis() +
