...
ggplot()+ 
  geom_sf(data =   TreeCanopy%>%
  filter(CLASS_NAME != "Loss"), fill = "red", color = NA)+ 
...
```{r Fishnet Aggregation2, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
...
```{r Comparing Tree Canopy Area to Loss/Gain2, message=FALSE, warning=FALSE, fig.height = 8, fig.width = 12,  cache=TRUE}
...
```{r Comparing Tree Canopy Area to Loss/Gain, message=FALSE, warning=FALSE, fig.height = 7, fig.width = 10,  cache=TRUE}
...
```{r Comparing Demographics to Fishnet Variables, fig.height = 18, fig.width = 13,  cache=TRUE}
...
```{r Potential Risk Factors, fig.height = 18, fig.width = 13,  cache=TRUE}
