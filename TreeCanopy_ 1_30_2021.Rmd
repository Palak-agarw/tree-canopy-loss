...
const_spatial<- mutate(const_spatial,Date=paste(permitissuedate, sep=" ")) %>%
  dummy_cols(select_columns="Date", split=" ")

const_spatial <- const_spatial %>% separate(const_spatial$permitissuedate, c("PermitDate", "PermitTime"), sep = " ")
const <- const_spatial %>%
